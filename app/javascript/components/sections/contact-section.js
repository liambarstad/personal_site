      ...
      <footer data-name='contact' className='full-page' style={{ display: 'table' }}>
        <div className='full-page-display'>
          ...
          <p className='contact-detail'>
            <span className='softgreen' style={{fontFamily: 'inherit'}}>"Sometimes it's the people no one imagines anything of, who do the things that no one can imagine"</span> -- Alan Turing
          </p>
          {/*<div id='optimized'>
